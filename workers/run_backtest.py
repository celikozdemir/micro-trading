...
Usage:
    python -m workers.run_backtest
    python -m workers.run_backtest --symbol ETHUSDT
    python -m workers.run_backtest --symbol BTCUSDT --start 2026-03-01T09:00:00 --end 2026-03-01T10:00:00
    python -m workers.run_backtest --diagnose        # show threshold recommendations only
"""
...
async def main() -> None:
    parser = argparse.ArgumentParser(description="Burst momentum backtest")
    ...
    await run(args.symbol, start, end, diagnose=args.diagnose)
